execute at @s if score @s svm_ep.rotation matches 256.. run tp @s ~ ~ ~ ~256 ~
execute if score @s svm_ep.rotation matches 256.. run scoreboard players remove @s svm_ep.rotation 256
...
execute if score @s svm_ep.rotation matches 1.. as @s run function svm_ep:system/set_random_rotation_x