scoreboard players add @s svm_ep.p.healing_ability_04_delay 1

execute as @s[scores={svm_ep.using_move=383..}] run return 0
...
scoreboard players set @s svm_ep.p.healing_ability_04_delay 300
...
execute positioned ~ ~1 ~ as @e[tag=same_id,sort=nearest] run function svm_ep:power/healing/health_spread/shoot
