...
execute as @s[scores={svm_ep.p.dimension_traveler_gate_destination=5}] if dimension svm_ep:cherry_island run function svm_ep:power/dimension_traveler/selection/switch