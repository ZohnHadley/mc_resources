...
execute as @s[type=player,advancements={svm_ep:unlocked_ability/flora/8=false}] run return 0
...
scoreboard players operation %cooldown1 svm_ep.numbers = @s svm_ep.p.flora_ability_08_delay
function svm_ep:system/cooldown/calculate
execute if score %cooldown1 svm_ep.numbers matches 1.. run return run function svm_ep:system/message/on_cooldown


scoreboard players set @s svm_ep.p.flora_ability_08_delay 6
scoreboard players operation @s[type=player] svm_ep.p.flora_ability_08_delay += @s svm_ep.tick
scoreboard players operation @s[type=!player] svm_ep.p.flora_ability_08_delay += %WORLD svm_ep.tick



scoreboard players set @s svm_ep.using_move 2750
scoreboard players add @s svm_ep.used_move 1


scoreboard players reset @s svm_ep.p.flora_harvest_type
