...
execute at @n[tag=same_id] run function svm_ep:power/flora/vine_swing/distance_start
...
#STRETCH
execute store result entity @s transformation.scale[1] double 0.01 run data get storage svm_ep:numbers distance
...
execute on vehicle run function svm_ep:power/flora/vine_swing/motion_tick
execute as @s if score %STATE svm_ep.numbers matches 0 as @s[tag=!svm_ep.active] as @n[tag=same_id] run function svm_ep:power/flora/vine_swing/launch

execute as @s if score %STATE svm_ep.numbers matches 0 as @n[tag=same_id] run function svm_ep:power/flora/vine_swing/launch_player
