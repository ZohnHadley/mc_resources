...
execute at @s run tp @s ~ ~3.5 ~

execute store result score @s pos.x run data get entity @s Pos[0] 70
execute store result score @s pos.y run data get entity @s Pos[1] 50
...
execute store result score @s pos.y2 run data get entity @s Pos[1] 50
