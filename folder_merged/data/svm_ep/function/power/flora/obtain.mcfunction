...
tag @s add svm_ep.flora_user
tag @s add svm_ep.power_user
advancement grant @s only svm_ep:storyline/get_flora
...
scoreboard players set @s svm_ep.ability7 8
scoreboard players set @s svm_ep.ability8 9