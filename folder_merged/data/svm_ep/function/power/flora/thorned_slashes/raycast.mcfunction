...
execute as @s[tag=end_raycast] run function svm_ep:power/flora/thorned_slashes/end
#as @e[dx=0,tag=!executor,type=!#svm_ep:technical,tag=!hitby]
execute as @s[tag=!end_raycast] positioned ^ ^ ^0.15 run function svm_ep:power/flora/thorned_slashes/raycast