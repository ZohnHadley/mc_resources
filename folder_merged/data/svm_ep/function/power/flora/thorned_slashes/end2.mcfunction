...
execute as @e[dx=0,tag=!executor,type=!#svm_ep:technical,team=!svm_ep.cherry_guardians] run damage @s 1 svm_ep:bypass_cooldown by @e[tag=executor,limit=1]
execute as @e[dx=0,tag=!executor,type=!#svm_ep:technical,team=!svm_ep.cherry_guardians] run scoreboard players add @s svm_ep.e.flora_thorned 5
...
execute as @e[dx=0,tag=!executor,type=!#svm_ep:technical,team=!svm_ep.cherry_guardians] at @s run playsound minecraft:entity.player.attack.crit hostile @a[distance=..13] ~ ~1 ~ 1 1.1
