...
execute as @s[type=player,advancements={svm_ep:unlocked_ability/death/3=false}] run return 0
...
scoreboard players set @s svm_ep.p.death_ability_03_delay 200
execute as @s[scores={svm_ep.p.death_unsealed_reaper=1..}] run scoreboard players operation @s svm_ep.p.death_ability_03_delay *= %unsealed_reaper_cooldown_multiplier svm_ep.world_settings
execute as @s[scores={svm_ep.p.death_unsealed_reaper=1..}] run scoreboard players operation @s svm_ep.p.death_ability_03_delay /= %unsealed_reaper_cooldown_divisor svm_ep.world_settings
scoreboard players operation @s[type=player] svm_ep.p.death_ability_03_delay += @s svm_ep.tick
scoreboard players operation @s[type=!player] svm_ep.p.death_ability_03_delay += %WORLD svm_ep.tick
