...
execute as @s[tag=end_raycast] run function svm_ep:power/lightning/sword/end
#as @e[dx=0,tag=!executor,type=!#svm_ep:technical,tag=!hitby]
execute as @s[tag=!end_raycast] positioned ^ ^ ^0.15 run function svm_ep:power/lightning/sword/raycast