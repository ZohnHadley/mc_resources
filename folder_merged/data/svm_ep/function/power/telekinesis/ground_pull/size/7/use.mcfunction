...
#COPY TO TECH
 #OLD LOCATION
clone ~-8 ~-8 ~-8 ~8 ~8 ~8 to svm_ep:technical 0 0 0 replace move

 #NEW LOCATION
execute at @s run clone ~-8 ~-8 ~-8 ~8 ~8 ~8 to svm_ep:technical 0 32 0
...
#ON FAIL
execute if score %can_move svm_ep.numbers matches 0 run return run clone from svm_ep:technical 0 0 0 16 16 16 ~-8 ~-8 ~-8


#ON SUCCESS
execute at @s run fill ~8 ~8 ~8 ~-8 ~-8 ~-8 air destroy
clone from svm_ep:technical 0 0 0 16 16 16 ~-8 ~-8 ~-8 filtered #svm_ep:telekinesis_cant_move move
execute at @s run clone from svm_ep:technical 0 0 0 16 16 16 ~-8 ~-8 ~-8
