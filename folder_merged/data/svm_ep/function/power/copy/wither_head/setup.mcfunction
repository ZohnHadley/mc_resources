...
tp @s ~ ~ ~
execute store result entity @s Motion[0] double 0.0037 run scoreboard players operation @s pos.x2 -= @s pos.x
execute store result entity @s Motion[1] double 0.0037 run scoreboard players operation @s pos.y2 -= @s pos.y
execute store result entity @s Motion[2] double 0.0037 run scoreboard players operation @s pos.z2 -= @s pos.z
