data modify entity @s Offers.Recipes append value {maxUses:10,buy:{id:"stone",count:1b},sell:{id:"stone",count:1b},xp:0,rewardExp:0b}
loot replace entity @n[tag=svm_ep.tick_storage] container.0 loot svm_ep:npc/trade/paradise_trader/golden_pearl/buy
...
loot replace entity @n[tag=svm_ep.tick_storage] container.0 loot svm_ep:items/golden/pearl
