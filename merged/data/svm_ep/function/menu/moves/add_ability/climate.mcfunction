...
$data modify storage svm_ep:menu power.temp.climates append value {"label":$(name),"width":90,"action":{"type":"minecraft:run_command","command":"trigger svm_ep.z.mid_ability_input set $(id)"}}
$data modify storage svm_ep:menu power.temp.item_climates append value {"label":$(name),"width":90,"action":{"type":"minecraft:run_command","command":"trigger svm_ep.z.mid_ability_input set $(id)"}}
