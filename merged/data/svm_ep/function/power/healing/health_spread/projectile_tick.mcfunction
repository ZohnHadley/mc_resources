...
execute at @s[tag=!hit] run function svm_ep:power/healing/health_spread/move
execute if block ~ ~ ~ #svm_ep:no_physical_hitbox at @s[tag=!hit] run function svm_ep:power/healing/health_spread/move
execute if block ~ ~ ~ #svm_ep:no_physical_hitbox at @s[tag=!hit] run function svm_ep:power/healing/health_spread/move
execute at @s[tag=hit] run function svm_ep:power/healing/health_spread/hit


tag @s remove executor
tag @e remove same_id
kill @s[scores={svm_ep.lifetime=400..}]