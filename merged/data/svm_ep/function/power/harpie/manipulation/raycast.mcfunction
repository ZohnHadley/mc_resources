...
execute as @s[scores={svm_ep.raycast_length=1..}] positioned ^ ^ ^0.67 run return run function svm_ep:power/harpie/manipulation/raycast
function svm_ep:power/harpie/manipulation/end
