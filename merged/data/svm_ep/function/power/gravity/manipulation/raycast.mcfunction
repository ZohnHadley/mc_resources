...
execute as @s[tag=end_raycast] run function svm_ep:power/gravity/manipulation/end

execute as @s[tag=!end_raycast] positioned ^ ^ ^0.2 run function svm_ep:power/gravity/manipulation/raycast