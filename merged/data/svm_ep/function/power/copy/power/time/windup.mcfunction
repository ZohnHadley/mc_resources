execute as @s[scores={svm_ep.using_move=..1902}] run function svm_ep:power/time/stop/activate
scoreboard players reset @s[scores={svm_ep.using_move=..1902}] svm_ep.using_move
