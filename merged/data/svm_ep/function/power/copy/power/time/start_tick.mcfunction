...
scoreboard players add @s svm_ep.p.copy_ability_33_delay 4
...
execute unless entity @s[scores={svm_ep.using_move=1..}] run function svm_ep:power/copy/power/time/end_charge
