...
scoreboard players operation $strength player_motion.api.launch = %copy_cobweb_launch_strength svm_ep.world_settings
...
scoreboard players operation $strength player_motion.api.launch = %copy_cobweb_launch_strength_player svm_ep.world_settings
