...
#COPY TO TECH
 #OLD LOCATION
clone ~-3 ~-3 ~-3 ~3 ~3 ~3 to svm_ep:technical 0 0 0 replace move

 #NEW LOCATION
execute at @s run clone ~-3 ~-3 ~-3 ~3 ~3 ~3 to svm_ep:technical 0 32 0
...
#ON FAIL
execute if score %can_move svm_ep.numbers matches 0 run return run clone from svm_ep:technical 0 0 0 6 6 6 ~-3 ~-3 ~-3


#ON SUCCESS
execute at @s run fill ~3 ~3 ~3 ~-3 ~-3 ~-3 air destroy
clone from svm_ep:technical 0 0 0 6 6 6 ~-3 ~-3 ~-3 filtered #svm_ep:telekinesis_cant_move move
execute at @s run clone from svm_ep:technical 0 0 0 6 6 6 ~-3 ~-3 ~-3
