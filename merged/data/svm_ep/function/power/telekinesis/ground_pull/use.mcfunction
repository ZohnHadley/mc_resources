...
#COPY TO TECH
 #OLD LOCATION
$clone ~-$(r) ~-$(r) ~-$(r) ~$(r) ~$(r) ~$(r) to svm_ep:technical 0 0 0 replace move

 #NEW LOCATION
$execute $(new_pos) run clone ~-$(r) ~-$(r) ~-$(r) ~$(r) ~$(r) ~$(r) to svm_ep:technical 0 32 0
...
#ON FAIL
$execute if score %can_move svm_ep.numbers matches 0 run return run clone from svm_ep:technical 0 0 0 $(2r) $(2r) $(2r) ~-$(r) ~-$(r) ~-$(r)


#ON SUCCESS
$execute $(new_pos) run fill ~$(r) ~$(r) ~$(r) ~-$(r) ~-$(r) ~-$(r) air destroy
$clone from svm_ep:technical 0 0 0 $(2r) $(2r) $(2r) ~-$(r) ~-$(r) ~-$(r) filtered #svm_ep:telekinesis_cant_move move
$execute $(new_pos) run clone from svm_ep:technical 0 0 0 $(2r) $(2r) $(2r) ~-$(r) ~-$(r) ~-$(r)
