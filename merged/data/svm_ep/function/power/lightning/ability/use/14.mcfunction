scoreboard players set @s svm_ep.p.lightning_ability_14_delay 120
...
particle minecraft:dust_color_transition{from_color:[1.0f,1.0f,0.0f],to_color:[1.6f,0.0f,0.5f],scale:1.0f} ~ ~0.7 ~ 1.0 1.0 1.0 0.4 40
execute at @s run playsound minecraft:entity.allay.death ambient @a[distance=..20] ~ ~ ~ 1.4 0.7