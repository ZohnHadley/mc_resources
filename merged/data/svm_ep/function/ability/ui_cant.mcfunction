...
$title @s actionbar [$(mana_display),$(ability_name),{"text":"| ","color":"#858585"},{"score":{"name":"%cooldown1","objective":"svm_ep.numbers"},"color":"red"},{"text":".","color":"red"},{"score":{"name":"%cooldown2","objective":"svm_ep.numbers"},"color":"red"}]
