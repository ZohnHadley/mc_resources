...
execute store result score %consume ci.math if items entity @s armor.head *[minecraft:custom_data~{player_killed_entity:{head:{consume:{}}}}]


execute as @s[tag=!ci.cd] if score %consume ci.math matches 1.. run item modify entity @s armor.head {function:"minecraft:set_count",count:-1,add:1}
...
execute if score %consume ci.math matches 1.. run item modify entity @s armor.head {function:"minecraft:set_count",count:-1,add:1}
...
item modify entity @s armor.head {function:"minecraft:copy_custom_data",source:{type:"minecraft:storage",source:"ci:item"},ops:[{source:"cooldown",target:"player_killed_entity.head.cooldown",op:"merge"}]}
